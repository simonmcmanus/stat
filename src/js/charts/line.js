      ...
      if (args.legend_target) {
        if (args.colors && args.colors.constructor === Array) {
          plot.legend_text = "<span style='color:" + args.colors[which_line] + "'>&mdash; " +
            ...
            var text = plot.legend_text;


          plot.legend_text = "<span class='key'><input type='checkbox' checked><span class='mg-line" + line_id + "-legend-color'> " +
            this_legend + '&nbsp;&mdash;&nbsp;</span><span class="realtime realtime' + line_id + '">?</span></span>' + plot.legend_text ;
        }
      } else {
